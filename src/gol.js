//Game of life
//Config
const { client, protect, fillRect, writeImg } = require("./client")
const { goButton, pauseButton } = require("./drawings.json")
...
protect(
	...
	async pixel => {
		...
		if (paused) {
			//Draw pause button
			await writeImg([457, 192], pauseButton)
		} else {
			//Draw go button
			await writeImg([457, 192], goButton)
		}
	}
)
